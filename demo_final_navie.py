...
def run_solver(M, tau, save_times=None, compute_courant=False):
    ...
    # === ВЯЗКОСТЬ (Навье-Стокса) ===
    mu = Constant(0.01)          # динамическая вязкость (подбирайте под Re)
