...
plt.savefig("Плотность_НавьеСтокса_1.png")
...
plt.savefig("Эволюция_плотности_НавьеСтокса_1.png")
...
plt.savefig("Эволюция_времени_НавьеСтокса_1.png")
...
for M in Ms:
    ...
    plt.plot(t_hist[:len(C_hist)], C_hist, label=f"M={M}")
...
plt.savefig("Эволюция_Куранта_НавьеСтокса_1.png")
